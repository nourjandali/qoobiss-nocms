...
export type ContentOneProps = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;

export const ContentOne = (props: ContentOneProps) => {
  ...
  return (
    <section className="pt-20 lg:pt-40">
      <div className="flex lg:flex-row flex-col justify-between items-center gap-24 lg:gap-0">
        <div className="container container-padding px-[5%]">
...
export const ContentOneDefaults: ContentOneProps = {
