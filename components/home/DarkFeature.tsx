...
import seamlessAnimation from "@/assets/seamless.json";
import scalabilityAnimation from "@/assets/scalability.json";
import workflowAnimation from "@/assets/automation.json";
import universalAnimation from "@/assets/universal.json";
