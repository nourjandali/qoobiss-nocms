...
export const Contact = (props: ContactProps) => {
  ...
  return (
    <section className="px-5 lg:px-[160px] pt-28 lg:py-48">
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-20">
        <div className="flex py-5 flex-col items-start gap-12 self-stretch">
          ...
          <div className="flex flex-col items-start gap-10 self-stretch">
            <div className="flex flex-col items-start gap-2.5">
              ...
              <div className="flex flex-col">
                <span className="text-light-chapeau text-sm leading-[140%]">
                  Expo Business Park
                </span>
                <span className="text-light-chapeau text-sm leading-[140%]">
        ...
        <div>
          <div className="flex py-5 flex-col items-start gap-2.5 self-stretch">
