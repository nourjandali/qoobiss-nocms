    ...
    <section className="pt-20 lg:pt-40">
      <div className="container container-padding">
        <div className="grid grid-cols-1 lg:grid-cols-[0.5fr_1fr] lg:justify-between items-start w-full gap-y-6">
          <h1 className="text-electric-violet text-sm font-semibold uppercase">
            {heading}
          </h1>
          <p className="text-4xl lg:text-11xl font-light justify-self-end">
...
export const OurSolutionDefaults: OurSolutionProps = {
  ...
  descriptionFirstPart: "Our solution statement",
  coloredText: "donec",
  descriptionSecondPart: "varius maximus",
};
