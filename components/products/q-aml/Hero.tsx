...
export const HeroDefaults: HeroProps = {
  ...
  description:
    "QAML is an AI and Biometric based platform that lets you identify, verify and know your client, manage client onboarding and contract signing in a completely automated way. Now you can optimize sales and clients’ contracting flows like never before.",
};
